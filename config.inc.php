...
// cms template
define("TEMPLATE","crystalx");

//TODO : to implement the below two features.
//takes value true or false. Make it true if you want verification mails to be sent on registration.
define("SEND_MAIL_ON_REGISTRATION",false);

//The email id that the cms uses
define("CMS_EMAIL", "no-reply@pragyan.org");
